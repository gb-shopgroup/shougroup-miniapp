...
<view class="modal" @click.stop>
	...
	<view class="modal-body">
		<view class="form-group">
			<text class="form-label required">拒绝理由</text>
			<input type="text" class="form-input" v-model="formData.val" placeholder="请输入拒绝理由" />
		</view>
	</view>
	...
	methods: {
		show(payload){
			...
			this.formData = {
				...
				orderNo: payload && payload.orderNo ? payload.orderNo : '',
				batchSelection: payload && payload.selection ? payload.selection : {},
				val: ''
			}
			this.showModal = true
		},
